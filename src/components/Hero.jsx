                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className={`space-y-8 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
                        <div className="inline-block">
                            <span className="px-4 py-2 bg-white/90 backdrop-blur-sm rounded-full text-purple-600 font-semibold text-sm shadow-lg">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                            ...
                            <br />
                            <span className="text-gray-800">Travel Smart</span>
                        </h1>

                        <p className="text-xl text-gray-700 leading-relaxed max-w-xl">
                            Experience the freedom of the open road with our reliable and comfortable vehicles.
                            We prioritize your safety and comfort, ensuring every journey is memorable for all the right reasons.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4">
                            <a
                                href="#booking"
                                className="group px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center"
                            >
                                Book Your Ride
                            ...
                            <a
                                href="#fleet"
                                className="px-8 py-4 bg-white text-purple-600 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-2 border-purple-200 text-center"
                            >
                                View Fleet
                            </a>
                        </div>
                    ...
                    <div className={`relative ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
                        <div className="relative">
                            ...
                            {/* Floating Card */}
                            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 shadow-2xl animate-float">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-600">All vehicles inspected</div>
                                    </div>
                                </div>
                            </div>
